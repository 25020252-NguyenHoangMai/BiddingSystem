...
* **Quỳnh :** Thiết kế cấu trúc Thực thể (Model), hệ thống xử lý Ngoại lệ (Exception), quy hoạch kiến trúc dự án và viết Unit Test (JUnit 5).
* **Mai:** Phụ trách Tầng truy cập dữ liệu (DAO Layer), thiết kế và tương tác trực tiếp với cơ sở dữ liệu SQL Server.
