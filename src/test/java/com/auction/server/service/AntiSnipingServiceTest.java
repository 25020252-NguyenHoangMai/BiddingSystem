...
public class AntiSnipingServiceTest {
    ...
    class testShouldExtend {
        ...
        @Test
        void StatusNotRunning_ReturnsFalse() {
            AuctionSession session = new AuctionSession();
        ...
        @Test
        void TimeAlreadyPassed_ReturnsFalse() {
            AuctionSession session = new AuctionSession();
            session.setStatus(SessionService.STATUS_RUNNING);
        ...
        @Test
        void RemainingTimeGreaterThan30s_ReturnsFalse() {
            AuctionSession session = new AuctionSession();
            session.setStatus(SessionService.STATUS_RUNNING);
        ...
        @Test
        void RemainingTimeLessThan30s_ReturnsTrue() {
            AuctionSession session = new AuctionSession();
            session.setStatus(SessionService.STATUS_RUNNING);
        ...
        @Test
        void RemainingTimeExactly30s_ReturnsTrue() {
            AuctionSession session = new AuctionSession();
            session.setStatus(SessionService.STATUS_RUNNING);
        ...
        @Test
        void StatusIsNull_ReturnsFalse_NoException() {
            AuctionSession session = new AuctionSession();
            session.setEndTime(LocalDateTime.now().plusSeconds(10));
        ...
        @Test
        void RemainingTimeIsOneMillisecond_ReturnsTrue() {
            AuctionSession session = new AuctionSession();
            session.setStatus(SessionService.STATUS_RUNNING);
        ...
        @Test
        void NowEqualsEndTime_ReturnsFalse() {
            AuctionSession session = new AuctionSession();
            session.setStatus(SessionService.STATUS_RUNNING);
        ...
        @Test
        void RemainingTimeExactly31s_ReturnsFalse() {
            AuctionSession session = new AuctionSession();
            session.setStatus(SessionService.STATUS_RUNNING);
