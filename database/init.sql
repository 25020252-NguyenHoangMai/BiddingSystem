USE [master]
GO
/****** Object:  Database [BiddingSystem]    Script Date: 5/14/2026 4:13:32 PM ******/
...
USE [BiddingSystem]
GO
/****** Object:  Table [dbo].[AuctionSession]    Script Date: 5/14/2026 4:13:33 PM ******/
SET ANSI_NULLS ON
GO
...
[id] ASC
    ...
    GO
/****** Object:  Table [dbo].[AutoBid]    Script Date: 5/14/2026 4:13:33 PM ******/
    SET ANSI_NULLS ON
    GO
    SET QUOTED_IDENTIFIER ON
    GO
...
[id] ASC
    ...
    GO
/****** Object:  Table [dbo].[BidTransaction]    Script Date: 5/14/2026 4:13:33 PM ******/
    SET ANSI_NULLS ON
    GO
    SET QUOTED_IDENTIFIER ON
    GO
...
[id] ASC
    ...
    GO
/****** Object:  Table [dbo].[Item]    Script Date: 5/14/2026 4:13:33 PM ******/
    SET ANSI_NULLS ON
    GO
    SET QUOTED_IDENTIFIER ON
    GO
...
[id] ASC
    ...
    GO
/****** Object:  Table [dbo].[Users]    Script Date: 5/14/2026 4:13:33 PM ******/
    SET ANSI_NULLS ON
    GO
    SET QUOTED_IDENTIFIER ON
    GO
...
[username] ASC
    ...
    SET ANSI_PADDING ON
    GO
/****** Object:  Index [IX_AutoBid]    Script Date: 5/14/2026 4:13:33 PM ******/
...
ALTER TABLE [dbo].[Item] CHECK CONSTRAINT [FK_Item_Users]
    GO
ALTER TABLE [dbo].[AuctionSession]  WITH CHECK ADD  CONSTRAINT [CK_AuctionSession_Status] CHECK  (([status]='CANCELLED' OR [status]='FINISHED' OR [status]='RUNNING' OR [status]='OPEN'))
    GO
